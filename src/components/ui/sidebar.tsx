...
const SidebarContext = React.createContext<
  (SidebarContext & { closeSidebar?: () => void }) | null
>(null);
...
>(
  (
    ...
    if (isMobile) {
      // Provide a closeSidebar function in context for mobile
      const closeSidebar = () => setOpenMobile(false);
      return (
        <SidebarContext.Provider value={{ ...sidebarContext, closeSidebar }}>
          <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
            <SheetContent
              ...
              side={side}
            >
              {/* Accessibility: Add a visually hidden SheetTitle for screen readers */}
              <span
                style={{
                  position: "absolute",
                  width: 1,
