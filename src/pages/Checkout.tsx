    ...
    return (
      <Layout>
        <div className="ethnic-container py-8 text-center">
          ...
          <p className="mb-6 text-muted-foreground">Please login to proceed with checkout</p>
  ...
  return (
    <Layout>
      <div className="ethnic-container py-4 md:py-8">
        <Link to="/cart" className="inline-flex items-center text-sm hover:text-ethnic-purple mb-6">
              ...
              <Card className="p-5">
                ...
                {user?.addresses.length === 0 ? (
                  <div className="text-center py-4">
                    <p className="text-muted-foreground mb-3">You haven't added any addresses yet</p>
              ...
              <Card className="p-5">
                ...
                <div className="bg-muted rounded-md p-4 mb-6">
                  ...
                  <ol className="list-decimal pl-5 space-y-2 mt-2 text-sm">
                    <li>Pay using your UPI app to: <span className="font-medium">sakhya@ybl</span></li>
                    <li>Enter the exact amount: {formatPrice(cartTotal + (cartTotal >= 1999 ? 0 : 99))}</li>
                ...
                <div className="border-2 border-dashed rounded-md p-4 text-center">
                  ...
                  {!paymentProof ? (
                    <label htmlFor="payment-proof" className="cursor-pointer block py-6">
                      <FileUp className="mx-auto h-8 w-8 text-muted-foreground mb-2" />
                      <p className="font-medium">Upload Payment Screenshot</p>
                      <p className="text-sm text-muted-foreground mt-1">Click to browse</p>
                    </label>
                  ) : (
                    <div className="py-2">
                      <p className="text-sm mb-2">
                        <span className="font-medium">File uploaded:</span> {paymentProof.name}
                      </p>
